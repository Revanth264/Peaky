 ...
 */
import { AppStore } from './lifecycle.js';
import { app, appCheck, auth, messaging, machineLearning, storage, firestore, database, instanceId, installations, projectManagement, securityRules, remoteConfig, AppOptions } from '../firebase-namespace-api.js';
import { cert, refreshToken, applicationDefault } from './credential-factory.js';
import App = app.App;
