...
export { AppMetadata, AppPlatform } from './app-metadata.js';
export { ProjectManagement } from './project-management.js';
export { AndroidApp, AndroidAppMetadata, ShaCertificate } from './android-app.js';
export { IosApp, IosAppMetadata } from './ios-app.js';
/**
...
export { FirebaseProjectManagementError, ProjectManagementErrorCode } from '../utils/error.js';
