...
import { google } from '../protos/firestore_v1_proto_api.js';
import { BulkWriter } from './bulk-writer.js';
import { BundleBuilder } from './bundle.js';
import { DocumentSnapshot, QueryDocumentSnapshot } from './document.js';
import { CollectionReference } from './reference/collection-reference.js';
import { DocumentReference } from './reference/document-reference.js';
import { Serializer } from './serializer.js';
import { Transaction } from './transaction.js';
import { FirestoreStreamingMethod, FirestoreUnaryMethod } from './types.js';
import { WriteBatch } from './write-batch.js';
import api = google.firestore.v1;
import { CollectionGroup } from './collection-group.js';
import { TraceUtil } from './telemetry/trace-util.js';
export { CollectionReference } from './reference/collection-reference.js';
export { DocumentReference } from './reference/document-reference.js';
export { QuerySnapshot } from './reference/query-snapshot.js';
export { Query } from './reference/query.js';
export type { AggregateQuery } from './reference/aggregate-query.js';
export type { AggregateQuerySnapshot } from './reference/aggregate-query-snapshot.js';
export type { VectorQuery } from './reference/vector-query.js';
export type { VectorQuerySnapshot } from './reference/vector-query-snapshot.js';
export type { VectorQueryOptions } from './reference/vector-query-options.js';
export { BulkWriter } from './bulk-writer.js';
export type { BulkWriterError } from './bulk-writer.js';
export type { BundleBuilder } from './bundle.js';
export { DocumentSnapshot, QueryDocumentSnapshot } from './document.js';
export { FieldValue, VectorValue } from './field-value.js';
export { Filter } from './filter.js';
export { WriteBatch, WriteResult } from './write-batch.js';
export { Transaction } from './transaction.js';
export { Timestamp } from './timestamp.js';
export { DocumentChange } from './document-change.js';
export type { DocumentChangeType } from './document-change.js';
export { FieldPath } from './path.js';
export { GeoPoint } from './geo-point.js';
export { CollectionGroup };
export { QueryPartition } from './query-partition.js';
export { setLogFunction } from './logger.js';
export { Aggregate, AggregateField } from './aggregate.js';
export type { AggregateFieldType, AggregateSpec, AggregateType, } from './aggregate.js';
export type { PlanSummary, ExecutionStats, ExplainMetrics, ExplainResults, } from './query-profile.js';
/**
